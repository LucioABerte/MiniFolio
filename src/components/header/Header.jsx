                ...
                <div className="profile__container grid">
                    <div className="profile__data">
                        ...
                        <ul className="profile__social animate__animated animate__fadeInDown animate__delay-0.8s">
                            <a href="https://minifolio-lucioaberte.vercel.app/" target="_blank" className="profile__social-link">
                                <i className="ri-home-4-line"></i>
                            </a>
                            <a href="https://www.linkedin.com/in/lucioaberte/" target="_blank" className="profile__social-link">
                    ...
                    <div className="profile__buttons">
                            ...
                            <a download="" href="LucioBertéCV(English).pdf" target="_blank" className="button animate__animated animate__fadeInLeft animate__delay-09s">
                        ...
                        <div className="profile__buttons-small animate__animated animate__fadeInRight animate__delay-1.1s">
                            <a href="https://api.whatsapp.com/send/?phone=5492233479633&text&type=phone_number&app_absent=0" target="_blank" className="button button__small button__gray">
                                <i className="ri-whatsapp-line"></i>
                            </a>
                            <a href="https://www.linkedin.com/in/lucioaberte/" target="_blank" className="button button__small button__gray">
